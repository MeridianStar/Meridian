                  ...
                  <div style={{display:"flex",alignItems:"flex-start",gap:10,padding:"8px 16px",cursor:"pointer"}}
                    ...
                    <div style={{flex:1,minWidth:0,display:"flex",
                      ...
                      {(badgeNome||fmtDL(t.deadline))&&(
                        <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",
                          gap:1,flexShrink:0,fontSize:11,color:Z.t3,minWidth:0,width:72}}>
                          {area&&(
                            <div style={{display:"flex",alignItems:"center",gap:3,width:"100%",justifyContent:"flex-end"}}>
                              <span style={{width:4,height:4,borderRadius:"50%",background:area.color,flexShrink:0}}/>
                              <span style={{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:60}}>{badgeNome}</span>
                            </div>
                          )}
                          {(()=>{const dl=fmtDL(t.deadline);return dl?<span style={{color:isUrgent&&!t.done?"#c94040":Z.t3,fontWeight:isUrgent&&!t.done?600:400,whiteSpace:"nowrap",display:"block",textAlign:"right"}}>{dl.txt}</span>:null;})()}
                        </div>
                      )}
                    </div>
                  </div>

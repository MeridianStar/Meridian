            ...
            {[6,5,4,3,2,1,0].map(n=>{
              ...
              return(
                <div key={n} style={{
                  ...
                  background:wasDone?sc.c:isToday?"rgba(0,0,0,0.15)":"rgba(0,0,0,0.08)",
                  border:isToday?`1.5px solid ${sc.c}50`:"none"
                }}/>
              );
            })}
          </div>
                  ...
                  <div style={{display:"flex",alignItems:"flex-start",gap:10,padding:"8px 16px",cursor:"pointer"}}
                    ...
                    <div style={{flex:1,minWidth:0,display:"flex",
                      ...
                      {(badgeNome||fmtDL(t.deadline))&&(
                        <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",
                          gap:2,flexShrink:0,fontSize:11,color:Z.t3,maxWidth:80}}>
                          {area&&(
                            <div style={{display:"flex",alignItems:"center",gap:4,whiteSpace:"nowrap"}}>
                              <span style={{width:4,height:4,borderRadius:"50%",background:area.color,flexShrink:0}}/>
                              <span style={{overflow:"hidden",textOverflow:"ellipsis",maxWidth:70}}>{badgeNome}</span>
                            </div>
                          )}
                          {(()=>{const dl=fmtDL(t.deadline);return dl?<span style={{color:isUrgent&&!t.done?"#c94040":Z.t3,fontWeight:isUrgent&&!t.done?600:400,whiteSpace:"nowrap"}}>{dl.txt}</span>:null;})()}
                        </div>
                      )}
                    </div>
                  </div>

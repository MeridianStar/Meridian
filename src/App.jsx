  ...
  return(
    <Sheet onClose={onClose}
      ...
      <div style={{display:"flex",alignItems:"center",
        ...
        {aId&&<span style={{fontSize:11,color:Z.t3}}>auto-rilevata ✦</span>}
      </div>
      ...
      {task.id&&conf?(
        ...
        <div style={{display:"flex",gap:8}}>
          ...
          <button onClick={()=>{
            ...
            style={{flex:2,padding:12,background:col,borderRadius:10,
              color:Z.t,fontSize:14,fontWeight:700}}>
    ...
    <div className="habit-row" style={{display:"flex",alignItems:"center",gap:0,
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",gap:8,
        ...
        {compact&&h.freq&&h.freq.type!=="none"&&(
          <div style={{display:"flex",gap:3,flexShrink:0,alignItems:"center",paddingRight:2}}>
            {[6,5,4,3,2,1,0].map(n=>{
              const day=ago(n);
                  ...
                  <div style={{display:"flex",alignItems:"flex-start",gap:10,padding:"8px 16px",cursor:"pointer"}}
                    ...
                    <div style={{flex:1,minWidth:0,display:"flex",
                      ...
                      {(badgeNome||fmtDL(t.deadline))&&(
                        <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",
                          gap:1,flexShrink:0,fontSize:11,color:Z.t3,width:68}}>
                          {area&&(
                            <div style={{display:"flex",alignItems:"center",gap:3,justifyContent:"flex-end"}}>
                              <span style={{width:4,height:4,borderRadius:"50%",background:area.color,flexShrink:0}}/>
                              <span style={{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",maxWidth:56}}>{badgeNome}</span>
                            </div>
                          )}
                          {(()=>{const dl=fmtDL(t.deadline);return dl?<span style={{color:isUrgent&&!t.done?"#c94040":Z.t3,fontWeight:isUrgent&&!t.done?600:400,whiteSpace:"nowrap",textAlign:"right",display:"block"}}>{dl.txt}</span>:null;})()}
                        </div>
                      )}
                    </div>
                  </div>

                ...
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                  ...
                  {editingTId===t.id?(
                    ...
                    <React.Fragment>
                      ...
                      <button
                        onClick={e=>{e.stopPropagation();
                          setEditingTId(t.id);setEditTxt(t.text);}}
    ...
    <div ref={swipeRef} style={{position:"relative",overflow:"hidden"}}>
      ...
      <div
        ...
        <div style={{flex:1,minWidth:0,cursor:"pointer"}}
          ...
          {(aName||d2)&&(
            <div style={{display:"flex",alignItems:"center",gap:5,marginTop:2,fontSize:10,color:Z.t3}}>
              {aName&&(<>
...
function App(){
  ...
  useEffect(()=>{
    const t1=setTimeout(()=>setContentReady(true),900);
    const t2=setTimeout(()=>setShowSplash(false),900+450);
    const t3=setTimeout(()=>setTransitionDone(true),900+550);
  ...
  return(
    ...
    {showSplash&&(
      <div style={{position:"fixed",inset:0,zIndex:9999,background:"#0a0a0a",
        ...
        <svg viewBox="0 0 200 200" width="92" height="92">
          <defs>
            <linearGradient id="splashArc" x1="0" y1="1" x2="1" y2="0">
              <stop offset="0%" stopColor="#fd5108"/>
              <stop offset="50%" stopColor="#ff8a3d"/>
              <stop offset="100%" stopColor="#ffcf94"/>
            </linearGradient>
            <radialGradient id="splashSun" cx="35%" cy="32%" r="65%">
          ...
          <path d="M26 132 A74 74 0 0 1 174 132" fill="none" stroke="#ffffff14" strokeWidth="16" strokeLinecap="round"/>
          <path d="M26 132 A74 74 0 0 1 174 132" fill="none" stroke="url(#splashArc)" strokeWidth="16" strokeLinecap="round"
            strokeDasharray="233" strokeDashoffset="233">
            <animate attributeName="strokeDashoffset" values="233;0;233" dur="1.6s" repeatCount="indefinite"/>
          </path>
          <circle r="19" fill="url(#splashSun)">
            <animateMotion path="M26 132 A74 74 0 0 1 174 132" dur="1.6s" repeatCount="indefinite"
    ...
    <div style={{maxWidth:480,margin:"0 auto",minHeight:"100dvh",
      ...
      ...(transitionDone?{}:{
        transform:contentReady?"translateY(0) scale(1)":"translateY(10px) scale(0.97)",

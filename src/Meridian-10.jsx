  ...
  return(
    <div style={{display:"flex",alignItems:"center",gap:0,
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",gap:8,
        padding:compact?"6px 10px":"10px 12px",minWidth:0,cursor:"pointer"}}
        onClick={()=>onEdit(h)}>
      ...
      <div style={{background:Z.s1,border:`1px solid ${Z.b}`,
        ...
        <svg viewBox="-42 -16 310 258" style={{display:"block",width:"100%"}}>
          ...
          <text x={CX} y={CY+15} textAnchor="middle" fontSize={7}
            fill="rgba(255,255,255,0.2)" fontFamily="'Lato',sans-serif">/10</text>
        </svg>
    ...
    <div style={{marginBottom:8,borderRadius:14,
      ...
      <div onClick={()=>setOpenG(isOpen?null:g.id)}
        ...
        <div style={{flex:1,minWidth:0}}>
          ...
          {dl&&(
            <div style={{fontSize:11,color:dl.u?"#f87171":"rgba(250,204,21,0.7)",
      ...
      <div style={{marginTop:24,borderRadius:20,overflow:"hidden",
        ...
        {dreams.map((d,i)=>(
          <div key={d.id} style={{display:"flex",alignItems:"center",gap:10,
            ...
            <span style={{color:"rgba(196,181,253,0.4)",fontSize:11,flexShrink:0}}>{"◇"}</span>
...
const HOME_ORDER=["h1","h2","h14","h6","h5","h10","h3","h51"];
  ...
  return(
    <div>
      ...
      {/* ABITUDINI */}
      <div className="up d1" style={{padding:"10px 16px 0",marginBottom:12}}>
        <div style={{marginBottom:10}}>
        ...
        {allDoneList.length>0&&!allDone&&(
          <div style={{marginTop:8}}>
            ...
            {showDone&&(
              <div style={{display:"flex",flexDirection:"column",gap:3,opacity:0.45,marginTop:4}}>
                {allDoneList.map(h=>(
                  <HRow key={h.id} h={h} tr={tr} logs={logs} onToggle={handleToggle} onEdit={onEditHabit} onLog={onLog} onDel={onDel} compact/>
                ))}
              </div>
...
function App(){
  ...
  return(
    <div style={{maxWidth:480,margin:"0 auto",minHeight:"100dvh",
      ...
      <div style={{position:"fixed",top:0,left:"50%",transform:"translateX(-50%)",
        ...
        <div style={{display:"flex",alignItems:"center",
          ...
          <div style={{display:"flex",alignItems:"baseline",gap:8,flexShrink:0,marginLeft:8,minWidth:0,overflow:"hidden"}}>
            <span style={{fontSize:11,color:"rgba(30,14,4,0.5)",textTransform:"capitalize",
            ...
            <span style={{fontSize:13,fontWeight:800,color:Z.t,
              fontFamily:"'JetBrains Mono',monospace"}}>
              {(data.vita?Math.round(Object.values(data.vita).reduce((s,v)=>s+v,0)/Object.values(data.vita).length*10)/10:0)}
              <span style={{fontSize:11,color:"rgba(30,14,4,0.55)"}}>/10</span>
            </span>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          ...
          <span style={{fontSize:12,fontWeight:600,color:Z.t,fontFamily:"'JetBrains Mono',monospace",flexShrink:0}}>
            {tdone}/{todayH.length}
          </span>
          <span style={{color:"rgba(30,14,4,0.48)",fontSize:11}}>·</span>
          <span style={{fontSize:12,fontWeight:600,color:Z.t,flexShrink:0}}>
      ...
      {/* CONTENT */}
      <div style={{flex:1,overflowY:"auto",padding:"70px 14px 80px",
        WebkitOverflowScrolling:"touch"}}

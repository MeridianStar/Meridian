...
const CSS=`
  *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent;}
  body{background:#f0e6d8;color:#1e0e04;font-family:'Lato',sans-serif;overscroll-behavior:none;}
  button{background:none;border:none;cursor:pointer;font-family:'Lato',sans-serif;}
  input,textarea{font-family:'Lato',sans-serif;}
  ::-webkit-scrollbar{display:none;}
  .habit-row:first-child{border-top:none !important;}
  .up{padding:0;}
...
//  TOKENS 
const Z={
  bg:"#f0e6d8",s1:"#e8ddd0",s2:"#e0d4c4",s3:"#d8c8b4",
  b:"rgba(0,0,0,0.08)",b2:"rgba(0,0,0,0.12)",
  t:"#1e0e04",t2:"#4a2818",t3:"#7a5040",
};
const SILVER="rgba(180,100,40,0.8)";
const SILVER_BRIGHT="#c87040";
const ERR_LIGHT="#c94040"; // rosso chiaro per task urgenti
  ...
  aree:[
    {id:"salute",icon:"⚡",  nome:"Energia",  color:"#facc15", cat:[
      {id:"mente",icon:"🧠",  nome:"Mente",       h:[
        {id:"h1",nome:"Sveglia alle 6:45",        icon:"⏰",s:"green",note:"",freq:{type:"daily"},      logType:"sveglia",  milestones:[]},
...
const ICONS={
  home:    (a)=>React.createElement('svg',{width:18,height:18,viewBox:"0 0 24 24",fill:"none",stroke:a?"#c87040":"rgba(120,80,50,0.45)",strokeWidth:2,strokeLinecap:"round"},React.createElement('path',{d:"M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"}),React.createElement('polyline',{points:"9 22 9 12 15 12 15 22"})),
  abitudini:(a)=>React.createElement('svg',{width:18,height:18,viewBox:"0 0 24 24",fill:"none",stroke:a?"#c87040":"rgba(120,80,50,0.45)",strokeWidth:2,strokeLinecap:"round"},React.createElement('path',{d:"M9 11l3 3L22 4"}),React.createElement('path',{d:"M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"})),
  task:    (a)=>React.createElement('svg',{width:18,height:18,viewBox:"0 0 24 24",fill:"none",stroke:a?"#c87040":"rgba(120,80,50,0.45)",strokeWidth:2,strokeLinecap:"round"},React.createElement('rect',{x:"3",y:"3",width:"7",height:"7"}),React.createElement('rect',{x:"14",y:"3",width:"7",height:"7"}),React.createElement('rect',{x:"14",y:"14",width:"7",height:"7"}),React.createElement('rect',{x:"3",y:"14",width:"7",height:"7"})),
  obiettivi:(a)=>React.createElement('svg',{width:18,height:18,viewBox:"0 0 24 24",fill:"none",stroke:a?"#c87040":"rgba(120,80,50,0.45)",strokeWidth:2,strokeLinecap:"round"},React.createElement('circle',{cx:"12",cy:"12",r:"10"}),React.createElement('circle',{cx:"12",cy:"12",r:"6"}),React.createElement('circle',{cx:"12",cy:"12",r:"2"})),
  visione: (a)=>React.createElement('svg',{width:18,height:18,viewBox:"0 0 24 24",fill:"none",stroke:a?"#c87040":"rgba(120,80,50,0.45)",strokeWidth:2,strokeLinecap:"round"},React.createElement('polygon',{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"})),
  analisi: (a)=>React.createElement('svg',{width:18,height:18,viewBox:"0 0 24 24",fill:"none",stroke:a?"#c87040":"rgba(120,80,50,0.45)",strokeWidth:2,strokeLinecap:"round"},React.createElement('path',{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"})),
};
...
function fmtDL(s){
  ...
  if(diff===0)return{txt:"",c:"#facc15",u:false};
      ...
      <div ref={ref} onScroll={onScroll}
        ...
        {items.map(item=>(
          <div key={item.val} style={{height:ITEM_H,display:"flex",alignItems:"center",
            ...
            fontSize:18,fontWeight:600,color:item.val===value?Z.t:Z.t3,
              ...
              <div style={{display:"flex",gap:6,minWidth:"max-content"}}>
                {[...patrimoniStorico].reverse().map((m,i)=>(
                  <div key={m.id} style={{width:128,background:Z.s2,borderRadius:10,
                    ...
                    <div style={{fontSize:11,fontWeight:700,color:Z.t3,marginBottom:6,
                      fontFamily:"'JetBrains Mono',monospace"}}>{m.label}</div>
                    {[["cripto","Cripto","#f97316"],["relending","RE Lend","#7a5040"],
                      ["societa","Società","#38bdf8"],["azioni","Azioni","#2ea34e"],
                      ["pensione","Pensione","#f87171"],["deposito","Deposito","#38bdf8"],
                      ["liquidita","Liquidità","#f97316"],["backup","Backup","#7a5040"],
                    ].map(([k,l,col])=>(
                      <div key={k} style={{display:"flex",justifyContent:"space-between",marginBottom:2}}>
                        <span style={{fontSize:11,color:Z.t3}}>{l}</span>
                    ...
                    <div style={{marginTop:6,paddingTop:5,borderTop:"1px solid rgba(255,255,255,0.08)",
                      ...
                      <span style={{fontSize:11,color:Z.t3,fontWeight:700}}>TOT</span>
                      <span style={{fontSize:11,fontWeight:900,color:"#00e5a0",
                        fontFamily:"'JetBrains Mono',monospace"}}>
...
function LogSpese({h,data,setData}){
  ...
  const freqColor={una_tantum:"#7a5040",settimanale:"#38bdf8",
    mensile:"#00e5a0",trimestrale:"#facc15",annuale:"#7a5040"};
...
function LogRisparmi({h,data,setData}){
  ...
  const ROWS=[
    ...
    {k:"robo",     l:"Robo-Advisor",icon:"🤖",color:"#7a5040",readonly:false},
      ...
      {dims.map(dim=>{
        ...
        return(
          <div key={dim.id} style={{display:"flex",alignItems:"center",gap:12,
            ...
            <span style={{fontSize:11,color:sc.c,fontWeight:600}}>{sc.l}</span>
          </div>
        );
      })}
    </div>
            ...
            <div style={{display:"flex",alignItems:"flex-start",gap:8}}>
              ...
              <div style={{flex:1,minWidth:0,display:"flex",flexDirection:"column",justifyContent:"center"}}>
                ...
                {pross&&v.freq!=="una_tantum"&&(
                  <div style={{marginTop:3,fontSize:11,fontWeight:600,color:sc}}>
      ...
      {showForm?(
        <div style={{background:Z.s2,borderRadius:12,padding:"12px",
          ...
          <div style={{marginBottom:8}}>
            <div style={{fontSize:11,color:Z.t3,marginBottom:4,fontWeight:600}}>Data ultima visita</div>
          ...
          <div style={{marginBottom:10}}>
            <div style={{fontSize:11,color:Z.t3,marginBottom:6,fontWeight:600}}>Frequenza</div>
...
function EditHabit({item,tr,logs,data,setData:setDataProp,onSave,onDel,onClose,onSaveLog,onTogglePast}){
  ...
  return(
    <Sheet onClose={onClose} accent={col}>
      ...
      {/* Priorità */}
      <div style={{marginBottom:16}}>
        <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
          textTransform:"uppercase",marginBottom:8,
          fontFamily:"'Lato',sans-serif"}}>Priorità</div>
          ...
          {Object.entries(STATUS).map(([k,v])=>{
            ...
            return(
              <button key={k} onClick={()=>setSt(k)}
                ...
                <span style={{fontSize:11,color:sel?v.c:Z.t3,fontWeight:sel?700:400}}>
                  {v.l}
                </span>
              </button>
            );
      ...
      <div style={{marginBottom:16}}>
        <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
          textTransform:"uppercase",marginBottom:8,
          fontFamily:"'Lato',sans-serif"}}>Frequenza</div>
      ...
      {item.logType==="asset"&&(
        <div style={{marginBottom:16}}>
          <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
            textTransform:"uppercase",marginBottom:8,
            fontFamily:"'Lato',sans-serif"}}>💰 Patrimonio del mese</div>
      ...
      {item.logType==="risparmi"&&(
        <div style={{marginBottom:16}}>
          <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
            textTransform:"uppercase",marginBottom:8,
            fontFamily:"'Lato',sans-serif"}}>🏦 Simulatore Risparmi</div>
      ...
      {item.logType==="spese"&&(
        <div style={{marginBottom:16}}>
          <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
            textTransform:"uppercase",marginBottom:8,
            fontFamily:"'Lato',sans-serif"}}>📊 Gestione Spese</div>
      ...
      {item.logType==="relazione"&&(
        <div style={{marginBottom:16}}>
          <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
            textTransform:"uppercase",marginBottom:8,
            fontFamily:"'Lato',sans-serif"}}>❤️ Dimensioni</div>
      ...
      {item.logType==="visite"&&(
        <div style={{marginBottom:16}}>
          <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
            textTransform:"uppercase",marginBottom:8,
            fontFamily:"'Lato',sans-serif"}}>🩺 Visite</div>
      ...
      <div style={{marginBottom:16}}>
        <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
          textTransform:"uppercase",marginBottom:8,
          fontFamily:"'Lato',sans-serif"}}>🏆 Milestone</div>
        {milestones.map(m=>{
          ...
          return(
            <div key={m.id} style={{display:"flex",alignItems:"center",
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                {m.date&&(
                  <div style={{fontSize:11,color:Z.t3,marginTop:2}}>{m.date}</div>
                )}
              </div>
              <button onClick={()=>{
                  if(confirmMsId===m.id){
      ...
      <div style={{marginBottom:16}}>
        <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
          textTransform:"uppercase",marginBottom:8,
          fontFamily:"'Lato',sans-serif"}}>Riflessioni</div>
        <textarea
          value={riflessioni}
      ...
      {/* Tracker settimana — tappabile per segnare pregresso */}
      <div style={{marginBottom:16,background:Z.s2,borderRadius:12,
        padding:"12px 14px",border:`1px solid ${Z.b}`}}>
        <div style={{fontSize:11,fontWeight:600,color:Z.t3,marginBottom:10}}>
          Ultimi 7 giorni — tocca per modificare
        </div>
        <div style={{display:"flex",gap:6,alignItems:"center"}}>
          {[6,5,4,3,2,1,0].map(n=>{
            const day=ago(n);
            const done=!!((tr&&tr[item.id]||{})[day]);
            const d=new Date();d.setDate(d.getDate()-n);
            const label=d.toLocaleDateString("it-IT",{weekday:"short"}).charAt(0).toUpperCase();
            return(
              <div key={n} style={{flex:1,display:"flex",flexDirection:"column",
                alignItems:"center",gap:4}}
                onClick={()=>onTogglePast&&onTogglePast(item.id,day)}>
                <div style={{width:28,height:28,borderRadius:"50%",
                  background:done?col:"transparent",
                  border:`2px solid ${done?col:Z.b2}`,
                  display:"flex",alignItems:"center",justifyContent:"center",
                  cursor:"pointer",transition:"all 0.15s"}}>
                  {done&&<span style={{color:"#fff",fontSize:11,fontWeight:700}}>✓</span>}
                </div>
                <span style={{fontSize:9,color:n===0?Z.t2:Z.t3,fontWeight:n===0?700:400}}>
                  {label}
                </span>
              </div>
            );
...
function EditTask({task,onSave,onDel,onClose,aree}){
  ...
  return(
    <Sheet onClose={onClose}
      ...
      {/* Scadenza */}
      <div style={{fontSize:11,fontWeight:600,color:Z.t3,marginBottom:6}}>Scadenza</div>
      <button onClick={()=>setShowDP(true)}
        style={{width:"100%",padding:"10px 13px",background:Z.s2,
          border:`1px solid ${dl?Z.b2:Z.b}`,
          borderRadius:10,color:dl?Z.t:Z.t3,fontSize:13,textAlign:"left",
          marginBottom:16,display:"flex",alignItems:"center",
          justifyContent:"space-between",boxSizing:"border-box"}}>
        <span>{dl?fmtDate(dl):"Nessuna scadenza"}</span>
        {dl&&<button onClick={e=>{e.stopPropagation();setDl("");}}
          style={{background:"transparent",border:"none",color:Z.t3,
            fontSize:14,padding:"0 2px",lineHeight:1,cursor:"pointer"}}>×</button>}
        {!dl&&<span style={{fontSize:11,color:Z.t3,opacity:0.4}}>📅</span>}
      </button>

      {/* Area */}
      <div style={{display:"flex",alignItems:"center",
        justifyContent:"space-between",marginBottom:8}}>
        <div style={{fontSize:11,fontWeight:600,color:Z.t3,letterSpacing:"0.08em",
          textTransform:"uppercase"}}>Area</div>
        {aId&&<span style={{fontSize:10,color:Z.t3,opacity:0.6}}>auto-rilevata</span>}
      </div>
        ...
        {aree.map(a=>(
          <button key={a.id} onClick={()=>{setAId(a.id===aId?"":a.id);setCId("");}}
            style={{padding:"5px 12px",borderRadius:20,fontSize:12,
              ...
              background:aId===a.id?`${a.color}20`:Z.s2,
              border:`1.5px solid ${aId===a.id?a.color:Z.b}`,
              color:aId===a.id?a.color:Z.t2}}>
            {a.icon&&<span style={{marginRight:4}}>{a.icon}</span>}{a.nome}
          </button>
        ))}
      </div>
      {cats.length>0&&(
          ...
          {cats.map(cat=>(
            <button key={cat.id} onClick={()=>setCId(cat.id===cId?"":cat.id)}
              style={{padding:"4px 10px",borderRadius:20,fontSize:11,
                ...
                background:cId===cat.id?`${selArea.color}15`:Z.s1,
      ...
      {/* Note */}
      <div style={{fontSize:11,fontWeight:600,color:Z.t3,marginBottom:6}}>Note</div>
      ...
      {task.id&&conf?(
        ...
        <div style={{display:"flex",gap:8}}>
          ...
          <button onClick={()=>{
            ...
            style={{flex:2,padding:12,background:Z.t2,borderRadius:10,
              color:Z.bg,fontSize:14,fontWeight:700}}>
...
function HRow({h,tr,logs,onToggle,onEdit,onLog,onDel,onChangeStatus,compact,showArea,grid,flat}){
  ...
  // Modalità griglia: card semplice senza swipe
  if(grid){
      ...
      <div style={{borderRadius:10,overflow:"hidden"}}>
        <div
          ...
          style={{minHeight:0,minWidth:0,display:"flex",alignItems:"center",
            gap:7,padding:"7px 8px",borderRadius:10,cursor:"pointer",
            background:done?"rgba(0,0,0,0.03)":Z.s1,
            border:`1px solid ${Z.b}`,
  ...
  return(
    <div className="habit-row" style={{display:"flex",alignItems:"center",gap:0,
      borderTop:`1px solid ${Z.b}`,background:done?"rgba(0,0,0,0.02)":"transparent"}}>
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",gap:8,
        padding:compact?"6px 10px":"10px 12px",minWidth:0,cursor:"pointer",overflow:"visible"}}
        onClick={()=>onEdit(h)}>
        ...
        <div style={{flex:1,minWidth:0,display:"flex",flexDirection:"column",justifyContent:"center"}}>
          ...
          {!compact&&h.freq&&h.freq.type!=="daily"&&h.freq.type!=="none"&&(
            <div style={{fontSize:11,color:Z.t3,marginTop:1}}>
        ...
        {/* Mini tracker settimanale — 7 pallini, solo in compact */}
        {compact&&h.freq&&h.freq.type!=="none"&&(
          <div style={{display:"flex",gap:2,flexShrink:0,alignItems:"center",paddingRight:2}}>
            {[6,5,4,3,2,1,0].map(n=>{
              const day=ago(n);
              const wasDone=!!((tr[h.id]||{})[day]);
              const isToday=n===0;
              return(
                <div key={n} style={{
                  width:isToday?8:7,height:isToday?8:7,borderRadius:"50%",flexShrink:0,
                  background:wasDone?sc.c:isToday?"rgba(0,0,0,0.25)":"rgba(0,0,0,0.12)",
                  border:isToday?`1.5px solid ${sc.c}60`:"1px solid rgba(0,0,0,0.1)"
                }}/>
              );
            })}
          </div>
...
function Vita({data,setData}){
  ...
  const gc=avg>=7?"#2ea34e":avg>=4?"#c46828":Z.t;

  const CX=113,CY=113,R=105;
  const SPAN=Math.PI/2,CSPAN=SPAN/3;
  const areaA=VITA_AREE.map((_,ai)=>{
    const s=-Math.PI/2+ai*SPAN,e=s+SPAN;
  ...
  return(
    <div style={{paddingBottom:20}}>
      ...
      <div style={{display:"flex",alignItems:"baseline",
        ...
        <h1 style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",textTransform:"uppercase",margin:0}}>Visione</h1>
      ...
      <div style={{background:Z.s1,border:`1px solid ${Z.b}`,
        ...
        <div style={{display:"flex",borderBottom:`1px solid ${Z.b}`}}>
          {[3,0].map((idx,li)=>{
            ...
            const sc=score>=7?area.color:score>=4?"#c46828":Z.t2;
              ...
              <button key={area.id}
                ...
                <div style={{display:"flex",alignItems:"center",gap:5,
                  ...
                  <span style={{fontSize:13,fontWeight:600,
                    color:Z.t2,letterSpacing:"-0.2px"}}>{area.nome}</span>
                </div>
        ...
        <svg viewBox="-42 -16 310 258" style={{display:"block",width:"100%"}}>
          ...
          <circle cx={CX} cy={CY} r={26} fill={Z.s1}
            stroke={Z.b} strokeWidth={1.5}/>
          <text x={CX} y={CY} textAnchor="middle" dominantBaseline="middle"
            fontSize={16} fontWeight={900} fill={Z.t}
            fontFamily={"'JetBrains Mono',monospace"}>{avg}</text>
          <text x={CX} y={CY+15} textAnchor="middle" fontSize={7}
            fill={Z.t3} fontFamily="'Lato',sans-serif">/10</text>
        </svg>
              ...
              <div key={i} style={{display:"flex",flexShrink:0}}>
                <button onClick={()=>setSelSnap(selSnap===i?null:i)}
                  style={{padding:"4px 9px",borderRadius:"7px 0 0 7px",fontSize:11,
                    ...
                    <span style={{width:7,height:7,borderRadius:"50%",
                      background:selSnap===i?"#c9a826":Z.b2,
                ...
                <button onClick={()=>{
                  ...
                  style={{padding:"4px 7px",borderRadius:"0 7px 7px 0",fontSize:11,
                    ...
                    color:"rgba(30,14,4,0.48)"}}>×</button>
              </div>
            ))}
          </div>
        </div>
            ...
            <div key={area.id} onClick={()=>setOpenArea(sel?null:area.id)}
              ...
              <div style={{padding:"11px 13px 9px",borderBottom:`1px solid ${Z.b}`}}>
                <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:6}}>
                  ...
                  <span style={{fontSize:13,fontWeight:700,
                    color:Z.t2,flex:1}}>{area.nome}</span>
                  <span style={{fontSize:20,fontWeight:900,color:sc,
                    fontFamily:"'JetBrains Mono',monospace"}}>{score}</span>
                </div>
                <div style={{height:4,background:Z.b2,borderRadius:2,overflow:"hidden"}}>
                    ...
                    return(
                      <div key={cat.id} style={{marginBottom:12}}>
                        <div style={{display:"flex",justifyContent:"space-between",
                          ...
                          <span style={{fontSize:13,fontWeight:800,color:Z.t2,
  ...
  return(
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",
        ...
        <h1 style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",textTransform:"uppercase",margin:0}}>Abitudini</h1>
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          <button onClick={toggleAll}
            style={{padding:"6px 12px",borderRadius:8,
              background:Z.s2,
              border:`1px solid ${Z.b}`,
              color:Z.t2,fontSize:12,fontWeight:600}}>
          ...
          <button onClick={()=>{setAddingH(true);}}
            style={{width:32,height:32,borderRadius:"50%",
              background:Z.s2,
              border:`1px solid ${Z.b}`,
              color:Z.t2,fontSize:20,fontWeight:300,
              display:"flex",alignItems:"center",justifyContent:"center",
              flexShrink:0}}>+</button>
        </div>
      </div>
      ...
      <div style={{display:"flex",gap:6,marginBottom:14}}>
        <button onClick={()=>setFilterArea(null)}
          style={{flex:1,padding:"6px 4px",borderRadius:10,
            background:!filterArea?Z.s2:Z.s1,
        ...
        <div key={grp.catId} style={{background:Z.s1,
          ...
          <div onClick={()=>setOpenCats(o=>({...o,[grp.catId]:!isCatOpen(grp.catId)}))}
            style={{padding:"7px 12px 6px",display:"flex",
              ...
              cursor:"pointer"}}>
            <span style={{fontSize:13,fontWeight:600,
              color:Z.t,letterSpacing:"0.01em",
              flex:1}}>
              {grp.catNome}
            </span>
  ...
  return(
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",
        justifyContent:"space-between",marginBottom:12}}>
        <div>
          <h1 style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",textTransform:"uppercase",margin:0}}>Task</h1>
          ...
          <div style={{display:"flex",alignItems:"center",
            ...
            <button onClick={()=>setShowDone(v=>!v)}
              style={{fontSize:12,color:Z.t3,padding:"4px 0",
                display:"flex",alignItems:"center",gap:4}}>
              <span style={{fontSize:11,display:"inline-block",
...
function GoalCard({g,openG,setOpenG,addTo,setAddTo,newT,setNewT,togT,delT,addT,updT,pctColor,setEditG}){
  ...
  return(
    <div style={{marginBottom:4,borderRadius:12,
      ...
      <div onClick={()=>setOpenG(isOpen?null:g.id)}
        ...
        <div style={{width:38,height:38,flexShrink:0,position:"relative",
          ...
          <svg width={38} height={38} style={{position:"absolute",top:0,left:0}}>
            <circle cx={19} cy={19} r={15} fill="none"
              stroke={Z.b2} strokeWidth={2.5}/>
            <circle cx={19} cy={19} r={15} fill="none"
              stroke={done100?"#2ea34e":pc} strokeWidth={2.5}
              strokeDasharray={`${(2*Math.PI*15*(done100?1:(tp||0)/100)).toFixed(1)} ${(2*Math.PI*15).toFixed(1)}`}
              strokeLinecap="round" transform="rotate(-90 19 19)"/>
          </svg>
          <span style={{fontSize:11,fontWeight:700,
            color:done100?"#2ea34e":Z.t,
          ...
          {gt.length>0&&(
            <div style={{height:3,background:Z.b2,borderRadius:2,overflow:"hidden"}}>
              <div style={{height:"100%",width:`${tp||0}%`,
                background:done100?"#2ea34e":pc,
                borderRadius:2,transition:"width 0.4s"}}/>
            </div>
          )}
          {dl&&(
            <div style={{fontSize:11,color:dl.u?"#c94040":Z.t3,
              marginTop:3}}>
              {dl.txt}
            </div>
          )}
        ...
        <div style={{display:"flex",alignItems:"center",flexShrink:0}}>
          <span style={{fontSize:16,color:Z.t3,opacity:0.35,
      ...
      {isOpen&&(
        <div style={{borderTop:`1px solid rgba(255,255,255,0.05)`}}>
            ...
            return(
              <div key={t.id}
                style={{padding:"8px 12px",
                  borderTop:i===0?"none":`1px solid ${Z.b}`}}>
                ...
                <div style={{display:"flex",alignItems:"center",gap:8}}>
                  ...
                  <div style={{display:"flex",flexDirection:"column",flexShrink:0,gap:1}}>
                    <button onClick={e=>{e.stopPropagation();
                      ...
                      style={{background:"transparent",border:"none",padding:"2px 5px",
                        color:i===0?Z.b2:Z.t3,
                        fontSize:12,lineHeight:1,cursor:i===0?"default":"pointer"}}>▲</button>
                    <button onClick={e=>{e.stopPropagation();
                      if(i===gt.length-1)return;
                      const arr=[...gt];arr.splice(i+1,0,arr.splice(i,1)[0]);
                      updT(g.id,arr,"reorder");}}
                      style={{background:"transparent",border:"none",padding:"2px 5px",
                        color:i===gt.length-1?Z.b2:Z.t3,
                        fontSize:12,lineHeight:1,cursor:i===gt.length-1?"default":"pointer"}}>▼</button>
                  </div>
                  {/* Check */}
                  <button onClick={e=>{e.stopPropagation();
                    ...
                    style={{width:20,height:20,borderRadius:"50%",flexShrink:0,
                      ...
                      display:"flex",alignItems:"center",justifyContent:"center",
                      cursor:"pointer"}}>
                    {tpct>=100&&<span style={{color:"#fff",fontSize:11,fontWeight:900}}>✓</span>}
                  </button>
                  ...
                  <button onClick={e=>{e.stopPropagation();
                    ...
                    style={{background:isSliderOpen?`${Z.b}`:"transparent",
                      border:`1px solid ${isSliderOpen?Z.b2:"transparent"}`,
                      borderRadius:6,padding:"2px 6px",
                      fontSize:11,fontWeight:700,color:Z.t2,
                  ...
                  <button onClick={e=>{e.stopPropagation();delT(g.id,t.id);}}
                    style={{background:"transparent",border:"none",
                      color:Z.t3,fontSize:16,opacity:0.4,
          ...
          {addTo===g.id?(
            <div style={{display:"flex",gap:8,padding:"10px 14px",
              ...
              <button onClick={()=>addT(g.id)}
                style={{padding:"8px 14px",background:pc,borderRadius:8,
                  color:Z.t,fontSize:14,fontWeight:700,border:"none"}}>+</button>
            ...
            <button onClick={e=>{e.stopPropagation();setAddTo(g.id);setNewT("");}}
              style={{width:"100%",padding:"10px 14px",background:"transparent",
                border:"none",borderTop:`1px solid ${Z.b}`,
          ...
          <button onClick={e=>{e.stopPropagation();setEditG(g);}}
            style={{width:"100%",padding:"7px 14px",background:"transparent",
              border:"none",borderTop:`1px solid ${Z.b}`,
              fontSize:11,color:Z.t3,textAlign:"right",cursor:"pointer",opacity:0.55}}>
            Modifica obiettivo ✎
          </button>
        </div>
      )}
...
function Obiettivi({data,setData,showToast,editG,setEditG,newG,setNewG}){
  ...
  return(
    <div style={{paddingBottom:20}}>
      <div style={{display:"flex",alignItems:"center",
        justifyContent:"space-between",marginBottom:12}}>
        <h1 style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",textTransform:"uppercase",margin:0}}>Obiettivi</h1>
        <button onClick={()=>setNewG(true)}
          style={{padding:"8px 16px",background:Z.s2,
            border:`1px solid ${Z.b2}`,borderRadius:20,
            color:Z.t2,fontSize:13,fontWeight:600}}>+ Nuovo</button>
      </div>
      ...
      {active.length>0&&(
        <div style={{background:Z.s1,border:`1px solid ${Z.b}`,
          ...
          <div style={{padding:"8px 14px",borderBottom:`1px solid ${Z.b}`,
            background:Z.s2,
            display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <span style={{fontSize:11,fontWeight:500,color:Z.t3,
      ...
      <div style={{marginTop:24,borderRadius:20,overflow:"hidden",
        ...
        <div style={{padding:"18px 18px 12px",display:"flex",alignItems:"center",gap:10}}>
          ...
          <div style={{flex:1}}>
            <div style={{fontSize:13,fontWeight:600,color:Z.t}}>
              Angolo dei Sogni
            </div>
            <div style={{fontSize:11,color:Z.t3,marginTop:2}}>
              Idee per il futuro
            </div>
          </div>
        </div>
        ...
        {dreams.length===0&&(
          <div style={{padding:"12px 18px 16px",
            fontSize:12,color:Z.t3,fontStyle:"italic"}}>
        ...
        {dreams.map((d,i)=>(
          <div key={d.id} style={{display:"flex",alignItems:"center",gap:10,
            padding:"10px 18px",
            borderTop:`1px solid ${Z.b}`}}>
            <span style={{color:Z.t3,fontSize:11,flexShrink:0}}>{"◇"}</span>
            <span style={{fontSize:13,color:Z.t,flex:1,lineHeight:1.5}}>
              {d.text}
            </span>
            <button onClick={()=>delDream(d.id)}
              style={{color:Z.t3,fontSize:16,padding:"0 2px",
        ...
        <div style={{display:"flex",gap:8,padding:"12px 16px 16px",
          ...
          <button onClick={saveDream}
            style={{width:38,height:38,borderRadius:12,flexShrink:0,
              ...
              color:Z.t,fontSize:18,fontWeight:300,
              display:"flex",alignItems:"center",justifyContent:"center",
  ...
  return(
    <div style={{overflowX:"hidden"}}>
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
        <h1 style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",textTransform:"uppercase",margin:0}}>{tab==="analisi"?"Analisi":"Lucius"}</h1>
        ...
        <div>
          ...
          <div style={{display:"flex",gap:8,marginBottom:14}}>
            {[
              ...
              <div key={l} style={{flex:1,background:Z.s1,borderRadius:12,padding:"12px 10px",
                ...
                <div style={{fontSize:11,color:Z.t3,marginTop:4,fontWeight:600,
          ...
          <div style={{background:Z.s1,borderRadius:14,padding:"14px 12px",
            ...
            <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
              ...
              fontFamily:"'Lato',sans-serif"}}>Completamento 30 giorni</div>
                  ...
                  <div key={b.day} style={{flex:1,display:"flex",flexDirection:"column",
                    ...
                    <div style={{width:"100%",height:52,display:"flex",
                      ...
                      <div style={{width:"100%",height:h,
                        background:isToday&&b.pct===0?"rgba(0,0,0,0.1)":(isToday?col:col+"99"),
                        borderRadius:"2px 2px 0 0",
                        border:isToday?"1px solid rgba(255,255,255,0.2)":"none",
                        boxShadow:isToday&&b.pct>0?`0 0 6px ${col}80`:"none"}}/>
                    </div>
                    <div style={{fontSize:11,color:isToday?Z.t:Z.t3,
          ...
          <div style={{background:Z.s1,borderRadius:14,padding:"12px 14px",
            ...
            <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
              textTransform:"uppercase",marginBottom:10,
              fontFamily:"'Lato',sans-serif"}}>Abitudini · ultimi 14 giorni</div>
            {/* Header date */}
            <div style={{display:"flex",alignItems:"center",gap:2,marginBottom:6}}>
              ...
              {days30.slice(-14).map((day,i)=>{
                ...
                return(
                  <div key={day} style={{flex:1,textAlign:"center",fontSize:11,
              ...
              return(
                <div key={h.id} style={{display:"flex",alignItems:"center",
                  ...
                  <div style={{width:80,flexShrink:0,display:"flex",alignItems:"center",gap:4}}>
                    ...
                    <span style={{fontSize:11,color:Z.t2,
                      overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
                      {h.nome.split(" ")[0]}
                    </span>
                  </div>
          ...
          <div style={{display:"flex",gap:8,marginBottom:12}}>
            ...
            <div style={{flex:1,background:Z.s1,borderRadius:14,padding:"12px",
              border:"1px solid rgba(0,0,0,0.08)"}}>
              <div style={{fontSize:11,fontWeight:700,color:"#2ea34e",
            ...
            <div style={{flex:1,background:Z.s1,borderRadius:14,padding:"12px",
              border:"1px solid rgba(0,0,0,0.08)"}}>
              <div style={{fontSize:11,fontWeight:700,color:"#c46828",
                textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:8}}>
                ↓ Da migliorare
              </div>
          ...
          <div style={{background:Z.s1,borderRadius:14,padding:"12px 14px",
            ...
            <div style={{fontSize:11,fontWeight:700,color:Z.t3,letterSpacing:"0.1em",
              textTransform:"uppercase",marginBottom:10,
              fontFamily:"'Lato',sans-serif"}}>Streak correnti</div>
        ...
        <div>
            ...
            <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
              {[
                ...
                <div key={l} style={{flex:1,minWidth:60}}>
                  ...
                  <div style={{fontSize:11,color:Z.t3,marginTop:1}}>{l}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="up d1" style={{textAlign:"center",padding:"28px 20px",
              ...
              <button onClick={()=>sendMsg("Come sto andando questa settimana?")}
                style={{padding:"12px 28px",background:SILVER,border:"none",
                  borderRadius:20,fontSize:13,fontWeight:700,color:Z.t,
          ...
          <div style={{borderTop:`1px solid ${Z.b}`,padding:"10px 0 0",
            ...
            <button onClick={()=>sendMsg(input)}
              style={{padding:"9px 14px",background:input.trim()?SILVER:Z.s2,
      ...
      <div
        ...
        <button onClick={()=>onToggle(t.id)}
          style={{width:20,height:20,borderRadius:"50%",flexShrink:0,padding:0,
            ...
            display:"flex",alignItems:"center",justifyContent:"center",
            color:Z.t,fontSize:11,fontWeight:700}}>
          {t.done&&"✓"}
        </button>
        <div style={{flex:1,minWidth:0,cursor:"pointer",display:"flex",
          ...
          {(aName||d2)&&(
            <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",
              gap:2,flexShrink:0,fontSize:11,color:Z.t3}}>
              {aName&&(
                <div style={{display:"flex",alignItems:"center",gap:5}}>
...
const HOME_ORDER=["h1","h2","h14","h6","h5","h10","h3","h51"];
  ...
  const todayTasks=useMemo(()=>{
    const today=tod();
    return (data.tasks||[]).filter(t=>t.deadline&&t.deadline<=today&&!t.done);
  },[data.tasks]);

  const tomorrowTasks=useMemo(()=>{
    const d=new Date();d.setDate(d.getDate()+1);
    const tomorrow=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,'0')}-${String(d.getDate()).padStart(2,'0')}`;
    return (data.tasks||[]).filter(t=>t.deadline===tomorrow&&!t.done);
  },[data.tasks]);

  const extraDone=habits.filter(h=>!todayH.find(t=>t.id===h.id)&&!!((tr[h.id]||{})[ts]));
  const allDoneList=[...doneToday,...extraDone];

  const handleToggle=useCallback((hId,day)=>{
    const wasDone=!!((tr[hId]||{})[day||ts]);
    onToggle(hId,day);
    if(!day&&!wasDone){setJustDone(hId);setTimeout(()=>setJustDone(null),600);}
  },[tr,ts,onToggle]);
  ...
  return(
    <div>
      ...
      {/* ABITUDINI */}
      <div className="up d1" style={{padding:"10px 16px 0",marginBottom:8}}>
        <div style={{marginBottom:10}}>
          <span style={{fontSize:11,fontWeight:700,color:"rgba(30,14,4,0.6)",letterSpacing:"0.12em",textTransform:"uppercase"}}>Abitudini</span>
        </div>

        {todayH.length===0?(
          <div style={{padding:"28px 0",textAlign:"center",color:"rgba(30,14,4,0.45)",fontSize:13}}>Nessuna abitudine prevista oggi</div>
        ):allDone?(
          <div>
            <div style={{background:"linear-gradient(135deg,rgba(0,229,160,0.09),rgba(0,229,160,0.03))",border:"1px solid rgba(0,229,160,0.12)",borderRadius:16,padding:"14px 16px",display:"flex",alignItems:"center",gap:12,marginBottom:12}}>
              ...
              <div>
                ...
                <div style={{fontSize:12,color:"rgba(30,14,4,0.52)",marginTop:2}}>Ottima giornata, Davide</div>
              </div>
            </div>
            <div style={{borderRadius:12,overflow:"hidden",border:`1px solid ${Z.b}`,opacity:0.45}}>
              {allDoneList.map(h=>(
          ...
          <div style={{borderRadius:12,overflow:"hidden",border:`1px solid ${Z.b}`}}>
            {rem.map(h=>{
        ...
        {allDoneList.length>0&&!allDone&&(
          <div style={{marginTop:8}}>
            <button onClick={()=>setShowDone(v=>!v)} style={{display:"flex",alignItems:"center",gap:6,padding:"5px 0",background:"transparent",border:"none",color:"rgba(30,14,4,0.48)",fontSize:11,cursor:"pointer"}}>
              <span style={{display:"inline-block",fontSize:11,opacity:0.5,transform:showDone?"rotate(90deg)":"rotate(0deg)",transition:"transform 0.2s"}}>{"▶"}</span>
              <span>Completate</span>
              <span style={{background:"rgba(0,229,160,0.08)",color:"#00e5a0",fontWeight:700,padding:"1px 7px",borderRadius:8,fontSize:11}}>{allDoneList.length}</span>
            </button>
            {showDone&&(
              <div style={{borderRadius:12,overflow:"hidden",border:`1px solid ${Z.b}`,opacity:0.45,marginTop:4}}>
                {allDoneList.map(h=>(
                  <HRow key={h.id} h={h} tr={tr} logs={logs} onToggle={handleToggle} onEdit={onEditHabit} onLog={onLog} onDel={onDel} compact/>
                ))}
              </div>
      ...
      {todayTasks.length>0&&(
        <div className="up d2" style={{padding:"0 16px 0"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
            <span style={{fontSize:11,fontWeight:700,color:"rgba(30,14,4,0.6)",letterSpacing:"0.12em",textTransform:"uppercase"}}>Task in scadenza oggi</span>
            <button onClick={onAddTask} style={{width:28,height:28,borderRadius:"50%",background:Z.s2,border:`1px solid ${Z.b2}`,color:Z.t2,fontSize:18,fontWeight:300,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer"}}>{"+"}</button>
          </div>
          <div style={{borderRadius:14,overflow:"hidden",background:Z.s1}}>
            {todayTasks.map((t,i)=>{
              ...
              return(
                <div key={t.id} style={{borderTop:i>0?`1px solid ${Z.b}`:"none",background:isUrgent?"rgba(248,113,113,0.03)":Z.s1}}>
                  <div style={{display:"flex",alignItems:"flex-start",gap:10,padding:"8px 16px",cursor:"pointer"}}
                    ...
                    <button onClick={e=>{e.stopPropagation();setData(d=>({...d,tasks:d.tasks.map(x=>x.id===t.id?{...x,done:!x.done}:x)}));}}
                      style={{width:20,height:20,borderRadius:"50%",flexShrink:0,padding:0,cursor:"pointer",marginTop:1,
                        background:t.done?"#2ea34e":"transparent",
                        border:`2px solid ${t.done?"#2ea34e":isUrgent?"rgba(201,64,64,0.4)":Z.b2}`,
                        display:"flex",alignItems:"center",justifyContent:"center"}}>
                      {t.done&&<span style={{color:"#fff",fontSize:11,fontWeight:900}}>{"✓"}</span>}
                    </button>
                    <div style={{flex:1,minWidth:0,display:"flex",
                      alignItems:"center",justifyContent:"space-between",gap:6}}>
                      <div style={{fontSize:13,color:t.done?Z.t3:Z.t,
                        fontWeight:t.done?400:500,minWidth:0,flex:1,
                      ...
                      {(badgeNome||fmtDL(t.deadline))&&(
                        <div style={{display:"flex",alignItems:"center",gap:4,
                          flexShrink:0,fontSize:11,color:Z.t3,whiteSpace:"nowrap"}}>
                          {area&&<span style={{width:5,height:5,borderRadius:"50%",background:area.color,flexShrink:0}}/>}
                          <span style={{overflow:"hidden",textOverflow:"ellipsis",maxWidth:72}}>
                            {[badgeNome,(()=>{const dl=fmtDL(t.deadline);return dl?dl.txt:null;})()].filter(Boolean).join(" · ")}
                          </span>
                        </div>
                      )}
                    </div>
      ...
      {tomorrowTasks.length>0&&(
        <div className="up d2" style={{padding:"16px 16px 0"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
            <span style={{fontSize:11,fontWeight:700,color:"rgba(30,14,4,0.6)",letterSpacing:"0.12em",textTransform:"uppercase"}}>Domani</span>
          </div>
          <div style={{borderRadius:12,overflow:"hidden",border:`1px solid ${Z.b}`}}>
            {tomorrowTasks.map((t,i)=>{
              const area=(data.aree||[]).find(a=>a.id===t.aId);
              const cat=area?.cat?.find(c=>c.id===t.cId);
              const badgeNome=cat?cat.nome:(area&&area.nome);
              return(
                <div key={t.id} style={{padding:"10px 14px",
                  ...
                  <div style={{flex:1,minWidth:0,display:"flex",
                    alignItems:"center",justifyContent:"space-between",gap:6}}>
                    <div style={{fontSize:13,color:Z.t,fontWeight:400,
                      minWidth:0,flex:1,
                      overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
                      {t.text}
                    </div>
                    {area&&(
                      <div style={{display:"flex",alignItems:"center",gap:3,flexShrink:0}}>
                        ...
                        <span style={{fontSize:11,color:Z.t3,whiteSpace:"nowrap",maxWidth:56,overflow:"hidden",textOverflow:"ellipsis"}}>{badgeNome}</span>
                      </div>
                    )}
                  </div>
                </div>
      ...
      {todayTasks.length===0&&tomorrowTasks.length===0&&(        <div style={{padding:"0 16px"}}>
          <div style={{position:"relative",overflow:"hidden",
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div>
                <div style={{fontSize:14,color:"rgba(30,14,4,0.5)",fontWeight:600,
                  letterSpacing:"0.01em"}}>
                  ✦ Giornata libera
                </div>
                <div style={{fontSize:11,color:"rgba(30,14,4,0.45)",marginTop:3,
    ...
    <div style={{
      ...
      {onUndo&&(
        <button onClick={()=>{onUndo();onDone();}}
          style={{padding:"4px 10px",background:Z.s2,
            border:`1px solid ${Z.b2}`,borderRadius:12,
    ...
    <span style={{display:"flex",alignItems:"center",gap:3,flexShrink:0}}>
      <svg width={18} height={18} style={{flexShrink:0}}>
        <circle cx={9} cy={9} r={r} fill="none"
          stroke={Z.b2} strokeWidth={2}/>
        <circle cx={9} cy={9} r={r} fill="none"
          stroke={Z.t2} strokeWidth={2}
          strokeDasharray={`${dash.toFixed(1)} ${circ.toFixed(1)}`}
          strokeLinecap="round"
          transform="rotate(-90 9 9)"/>
      </svg>
      <span style={{fontSize:12,fontWeight:700,color:Z.t2}}>{avg}%</span>
    </span>
  );
}
...
function App(){
  ...
  const [gistToken,setGistToken]=useState(()=>localStorage.getItem("m-gist-token")||"");
  const [gistId,setGistId]=useState(()=>localStorage.getItem("m-gist-id")||"");
  ...
  useEffect(()=>{
    ...
    // Auto-sync Gist ogni 7 giorni
    try{
      const token=localStorage.getItem("m-gist-token");
      const gistId=localStorage.getItem("m-gist-id");
      const lastGist=localStorage.getItem("m-gist-last-date");
      if(token&&gistId){
        const daysSince=lastGist
          ?Math.floor((Date.now()-parseInt(lastGist))/86400000)
          :8;
        if(daysSince>=7){
          // Sync silenzioso in background
          const snap={data,tr,logs,ts:Date.now()};
          fetch(`https://api.github.com/gists/${gistId}`,{
            method:"PATCH",
            headers:{"Authorization":`token ${token}`,"Content-Type":"application/json"},
            body:JSON.stringify({files:{"meridian-backup.json":{content:JSON.stringify(snap,null,2)}}})
          }).then(r=>{
            if(r.ok){
              localStorage.setItem("m-gist-last-date",Date.now().toString());
              localStorage.setItem("m-gist-last",new Date().toLocaleString("it-IT"));
            }
          }).catch(()=>{});
        }
      }
  ...
  return(
    <div style={{maxWidth:480,margin:"0 auto",minHeight:"100dvh",
      background:Z.bg,fontFamily:"'Lato',sans-serif",
        ...
        <div onClick={()=>setShowSettings(false)}
          ...
          <div onClick={e=>e.stopPropagation()}
            ...
            <div style={{padding:"20px 20px 0"}}>
              <div style={{fontSize:11,fontWeight:800,color:Z.t3,letterSpacing:"0.12em",
                textTransform:"uppercase",marginBottom:12,
                fontFamily:"'Lato',sans-serif"}}>Profilo</div>
            ...
            <div style={{padding:"0 20px 0"}}>
              <div style={{fontSize:11,fontWeight:800,color:Z.t3,letterSpacing:"0.12em",
                textTransform:"uppercase",marginBottom:12,
                fontFamily:"'Lato',sans-serif"}}>Lucius AI</div>
              <div style={{background:Z.s2,borderRadius:14,overflow:"hidden",
                border:`1px solid ${Z.b}`,marginBottom:20}}>
                <div style={{padding:"14px 16px",display:"flex",alignItems:"center",gap:12}}>
                  <div style={{width:36,height:36,borderRadius:10,
            ...
            {/* Sezione: Backup Cloud (GitHub Gist) */}
            {(()=>{
              const makePayload=()=>({
                description:"Meridian backup",
                public:false,
                files:{"meridian-backup.json":{
                  content:JSON.stringify({data,tr,logs,ts:Date.now()},null,2)
                }}
              });

              const syncGist=async()=>{
                if(!gistToken){setGistStatus("Token mancante");return;}
                setGistLoading(true);setGistStatus("");
                try{
                  const headers={"Authorization":`token ${gistToken}`,"Content-Type":"application/json"};
                  let id=gistId;
                  if(!id){
                    const r=await fetch("https://api.github.com/gists",{method:"POST",headers,body:JSON.stringify(makePayload())});
                    if(!r.ok)throw new Error(r.status);
                    const j=await r.json();
                    id=j.id;
                    localStorage.setItem("m-gist-id",id);
                    setGistId(id);
                  }else{
                    try{
                      const r=await fetch(`https://api.github.com/gists/${id}`,{method:"PATCH",headers,body:JSON.stringify(makePayload())});
                      if(!r.ok)throw new Error(r.status);
                    }catch(patchErr){throw patchErr;}
                  }
                  localStorage.setItem("m-gist-last",new Date().toLocaleString("it-IT"));
                  setGistStatus("✓ Sincronizzato");
                }catch(e){setGistStatus(`Errore: ${e.message}`);}
                setGistLoading(false);
              };

              const restoreGist=async()=>{
                if(!gistToken||!gistId){setGistStatus("Token o ID mancante");return;}
                setGistLoading(true);setGistStatus("");
                try{
                  const r=await fetch(`https://api.github.com/gists/${gistId}`,{headers:{"Authorization":`token ${gistToken}`}});
                  if(!r.ok)throw new Error(r.status);
                  const j=await r.json();
                  const raw=j.files["meridian-backup.json"]?.content;
                  if(!raw)throw new Error("File non trovato");
                  const parsed=JSON.parse(raw);
                  if(parsed.data)setData(parsed.data);
                  if(parsed.tr)setTr(parsed.tr);
                  if(parsed.logs)setLogs(parsed.logs);
                  setGistStatus("✓ Ripristinato");
                  showToast("Backup Gist ripristinato ✓");
                }catch(e){setGistStatus(`Errore: ${e.message}`);}
                setGistLoading(false);
              };
              ...
              return(
                <div style={{padding:"0 20px 0"}}>
                  <div style={{fontSize:11,fontWeight:800,color:Z.t3,letterSpacing:"0.12em",
                    textTransform:"uppercase",marginBottom:12,
                    fontFamily:"'Lato',sans-serif"}}>Backup Cloud</div>
                  <div style={{background:Z.s2,borderRadius:14,overflow:"hidden",
                    border:`1px solid ${Z.b}`,marginBottom:20,padding:"14px 16px"}}>

                    {/* Header info */}
                    <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
                      <span style={{fontSize:22}}>🐙</span>
                      <div>
                        <div style={{fontSize:13,fontWeight:700,color:Z.t}}>GitHub Gist</div>
                        <div style={{fontSize:11,color:Z.t3}}>Backup automatico privato e gratuito</div>
                      </div>
                    </div>

                    {/* Token input */}
                    <div style={{marginBottom:10}}>
                      <div style={{fontSize:11,color:Z.t3,marginBottom:5}}>
                        Personal Access Token {"("}<a href="https://github.com/settings/tokens/new?scopes=gist" target="_blank" style={{color:SILVER,textDecoration:"none"}}>crea qui</a>{")"}
                      </div>
                      <input type="password"
                        value={gistToken}
                        onChange={e=>{setGistToken(e.target.value);localStorage.setItem("m-gist-token",e.target.value);}}
                        placeholder="ghp_xxxxxxxxxxxx"
                        style={{width:"100%",background:Z.s1,border:`1px solid ${Z.b}`,
                          borderRadius:8,padding:"9px 12px",color:Z.t,fontSize:12,
                          outline:"none",boxSizing:"border-box",
                          fontFamily:"'JetBrains Mono',monospace"}}/>
                    </div>

                    {/* Gist ID (se già creato) */}
                    {gistId&&(
                      <div style={{marginBottom:10}}>
                        <div style={{fontSize:11,color:Z.t3,marginBottom:3}}>Gist ID (generato automaticamente)</div>
                        <div style={{fontSize:11,color:Z.t2,fontFamily:"'JetBrains Mono',monospace",
                          background:Z.s1,padding:"6px 10px",borderRadius:8,
                          overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>
                          {gistId}
                        </div>
                      </div>
                    ...
                    {/* Ultimo sync */}
                    {localStorage.getItem("m-gist-last")&&(
                      <div style={{fontSize:11,color:Z.t3,marginBottom:10}}>
                        Ultimo sync: {localStorage.getItem("m-gist-last")}
                      </div>
                    )}

                    {/* Status */}
                    {gistStatus&&(
                      <div style={{fontSize:12,color:gistStatus.startsWith("✓")?SILVER:"#c94040",
                    ...
                    {/* Bottoni */}
                    <div style={{display:"flex",gap:8}}>
                      <button onClick={syncGist} disabled={gistLoading}
                        style={{flex:1,padding:"10px",background:Z.s1,
                          border:`1px solid ${Z.b2}`,borderRadius:10,
                          color:Z.t,fontSize:12,fontWeight:600,
                          opacity:gistLoading?0.5:1}}>
                        {gistLoading?"...":gistId?"↑ Aggiorna":"↑ Crea backup"}
                      </button>
                      {gistId&&(
                        <button onClick={restoreGist} disabled={gistLoading}
                          style={{flex:1,padding:"10px",background:Z.s1,
                            border:`1px solid ${Z.b2}`,borderRadius:10,
                            color:Z.t,fontSize:12,fontWeight:600,
                            opacity:gistLoading?0.5:1}}>
            ...
            <div style={{padding:"0 20px 0"}}>
              <div style={{fontSize:11,fontWeight:800,color:Z.t3,letterSpacing:"0.12em",
                textTransform:"uppercase",marginBottom:12,
                fontFamily:"'Lato',sans-serif"}}>Dati</div>
              <div style={{background:Z.s2,borderRadius:14,overflow:"hidden",
                border:`1px solid ${Z.b}`,marginBottom:20}}>
      ...
      {editH&&<EditHabit item={editH} tr={tr} logs={logs} data={data} setData={setData} onSave={saveHabit} onDel={delHabit} onClose={()=>setEditH(null)} onSaveLog={saveWorkoutLog} onTogglePast={toggle}/>}
      {addingH&&(
              ...
              {data.aree.map(area=>(
                <button key={area.id}
                  ...
                  style={{padding:"6px 14px",borderRadius:20,fontSize:12,fontWeight:600,
                    ...
                    border:`1.5px solid ${addArea===area.id?area.color:"rgba(0,0,0,0.1)"}`,
      ...
      <div style={{position:"fixed",top:0,left:"50%",transform:"translateX(-50%)",
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          ...
          {/* Data estesa — occupa lo spazio a sinistra */}
          <span style={{flex:1,fontSize:12,fontWeight:600,color:Z.t,
          ...
          <div style={{display:"flex",alignItems:"center",gap:4,flexShrink:0}}>
            <svg width="34" height="12" viewBox="0 0 34 12" style={{flexShrink:0}}>
              <rect x="0.75" y="0.75" width="32.5" height="10.5" rx="2.5"
                fill="none" stroke={Z.b2} strokeWidth="1.5"/>
              <rect x="3" y="3" width={`${Math.max(0,(tpct/100)*27)}`} height="6" rx="1"
                fill={tpct===100?"#2ea34e":SILVER}/>
            </svg>
            <span style={{fontSize:11,fontWeight:700,
              color:tpct===100?"#2ea34e":Z.t2,whiteSpace:"nowrap"}}>
              {tdone}/{todayH.length}
            </span>
          </div>

          {/* Task */}
          <span style={{fontSize:11,fontWeight:700,color:Z.t2,
            whiteSpace:"nowrap",flexShrink:0}}>
          ...
          {/* Separatore */}
          <div style={{width:1,height:14,background:Z.b,flexShrink:0}}/>

          {/* Note */}
          <button onClick={()=>setShowNotes(true)}
            style={{background:"transparent",border:"none",opacity:0.45,padding:"3px",
              lineHeight:1,cursor:"pointer",display:"flex",alignItems:"center",flexShrink:0}}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
              stroke={Z.t} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* CONTENT */}
      <div style={{flex:1,overflowY:"auto",padding:"56px 14px 80px",
        WebkitOverflowScrolling:"touch"}}
        ...
        <div style={{animation:"fadeup 0.22s cubic-bezier(0.16,1,0.3,1) both"}}
          ...
          {backupBanner&&(
            <div style={{display:"flex",alignItems:"center",gap:10,
              ...
              <div style={{flex:1,minWidth:0}}>
                <div style={{fontSize:12,fontWeight:600,color:Z.t}}>
              ...
              <button onClick={()=>doBackup(false)}
                style={{flexShrink:0,padding:"7px 12px",fontSize:11,fontWeight:700,
                  background:Z.t,color:Z.bg,border:"none",
                  borderRadius:8,cursor:"pointer"}}>
                Esporta
              </button>
      ...
      <div style={{position:"fixed",bottom:0,left:0,right:0,zIndex:50,maxWidth:480,margin:"0 auto",
        background:"rgba(235,225,210,0.98)",
        backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",
        borderTop:`1px solid ${Z.b}`,
        ...
        {NAV.map(n=>{
          ...
          return(
            <button key={n.id} onClick={()=>setScreen(n.id)}
              ...
              <span style={{fontSize:11,fontWeight:a?700:400,
                color:a?"#c87040":Z.t3,letterSpacing:"0.01em"}}>
                {n.l}
              </span>
            </button>
          );

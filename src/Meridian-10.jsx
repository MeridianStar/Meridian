  ...
  return(
    <Sheet onClose={onClose}
      ...
      <div style={{fontSize:11,fontWeight:600,color:Z.t3,letterSpacing:"0.08em",
        textTransform:"uppercase",marginBottom:6}}>Scadenza</div>
      <button onClick={()=>setShowDP(true)}
        ...
        {!dl&&<span style={{fontSize:13,color:Z.t3,opacity:0.5}}>📅</span>}
      </button>
      ...
      {/* Note */}
      <div style={{fontSize:11,fontWeight:600,color:Z.t3,letterSpacing:"0.08em",
        textTransform:"uppercase",marginBottom:6}}>Note</div>
      ...
      {task.id&&conf?(
        ...
        <div style={{display:"flex",gap:8}}>
          ...
          <button onClick={()=>{
            ...
            style={{flex:2,padding:12,background:Z.t,borderRadius:10,
...
function GoalCircle({avg}){
  ...
  return(
    <span style={{display:"flex",alignItems:"center",gap:3}}>
      ...
      <span style={{fontSize:12,fontWeight:600,color:Z.t}}>{avg}%</span>
    </span>
  );
}
  ...
  return(
    <div style={{maxWidth:480,margin:"0 auto",minHeight:"100dvh",
      ...
      <div style={{position:"fixed",top:0,left:"50%",transform:"translateX(-50%)",
        ...
        {/* Riga 1: brand (sx) — azioni + punteggio (dx) */}
        <div style={{display:"flex",alignItems:"center",
          justifyContent:"space-between",marginBottom:6}}>

          {/* Brand + data sotto */}
          <div style={{display:"flex",flexDirection:"column",gap:1,minWidth:0}}>
            <span style={{fontSize:22,fontWeight:900,color:Z.t,
              letterSpacing:"-0.8px",lineHeight:1}}>Meridian</span>
            <span style={{fontSize:11,color:Z.t3,textTransform:"capitalize"}}>
              {(()=>{const d=new Date();
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
            ...
            <div style={{height:28,width:1,background:Z.b,marginLeft:2}}/>
            <span style={{fontSize:16,fontWeight:900,color:Z.t,
              fontFamily:"'JetBrains Mono',monospace",letterSpacing:"-0.5px"}}>
              {(data.vita?Math.round(Object.values(data.vita).reduce((s,v)=>s+v,0)/Object.values(data.vita).length*10)/10:0)}
              <span style={{fontSize:11,fontWeight:400,color:Z.t3}}>/10</span>
            </span>
          </div>
        </div>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <div style={{flex:1,height:3,background:Z.b2,borderRadius:2,overflow:"hidden"}}>
            <div style={{height:"100%",width:`${tpct}%`,
              background:tpct===100?"#2ea34e":SILVER,borderRadius:2,transition:"width 0.4s"}}/>
          </div>
          <span style={{fontSize:12,fontWeight:600,color:Z.t2,fontFamily:"'JetBrains Mono',monospace",flexShrink:0}}>
            {tdone}/{todayH.length}
          </span>
          <span style={{color:Z.t3,fontSize:11}}>·</span>
          <span style={{fontSize:12,fontWeight:600,color:Z.t2,flexShrink:0}}>
            {(data.tasks||[]).filter(t=>!t.done).length} Task
          </span>
          <span style={{color:"rgba(30,14,4,0.48)",fontSize:11}}>·</span>
          <GoalCircle avg={(data.goals&&data.goals.length)?Math.round(data.goals.reduce((s,g)=>s+(g.pct||0),0)/data.goals.length):null}/>
        </div>
      </div>

      {/* CONTENT */}
      <div style={{flex:1,overflowY:"auto",padding:"84px 14px 80px",
        WebkitOverflowScrolling:"touch"}}
